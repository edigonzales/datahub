...
// DISABLE
//@Component
public class TokenAuthorizationFilter_1 extends OncePerRequestFilter {
    ...
    public TokenAuthorizationFilter_1(ObjectContext objectContext, PasswordEncoder encoder) {
